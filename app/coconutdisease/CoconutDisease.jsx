  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <ScrollView style={styles.container}>
        <Image
          source={require("../assets/Coconutnut.jpg")} // Correct path to your image
          style={styles.image}
        />
        <View style={styles.content}>
          <Text style={styles.title}>Coconut Disease</Text>
          <Text style={styles.description}>
            You can upload your image and check whether the coconut is infected
            or not
          </Text>
          ...
          <Text style={styles.description}>
            Coconuts can suffer from various diseases such as root wilt, bud
            rot, and gray leaf spots. Early detection and management are
            crucial to prevent significant crop loss.
          </Text>
